          ...
          >
            <div className="space-y-1">
              ...
              <p className="text-sm text-base-content/65">
                Use a path or URL for normal insertion, or embed a local image as base64.
              </p>
            </div>
